    ...
    opts = {
      mappings = {
        n = {
          ...
          ["<Leader>fw"] = "<CMD>lua require('vscode').action('workbench.action.findInFiles')<CR>",
          ["<Leader>ls"] = "<CMD>lua require('vscode').action('workbench.action.gotoSymbol')<CR>",
          ["<Leader>"] = "<CMD>lua require('vscode').call('leaderkey.render')<CR>",
        },
      },
    },
  },
